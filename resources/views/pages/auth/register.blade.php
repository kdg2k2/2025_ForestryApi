                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-xl-7 col-lg-9 mt-3">
                        ...
                        <div class="card border mb-0">
                            <div class="card-body p-sm-6"><h3 class="mb-1">Đăng ký</h3>
                                <p class="mb-4 tx-muted">Đăng ký tài khoản để sử dụng dịch vụ.</p>
                                <form class="form-horizontal" action="index.html">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="mb-2 fw-500">Họ tên<span class="tx-danger ms-1">*</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="mb-2 fw-500">
                                                    <span class="d-inline-flex">Địa chỉ</span>
                                                    <span class="tx-muted op-7 ms-1 tx-12 fw-normal">(không bắt buộc)</span>
                                                </label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="mb-2 fw-500">Số điện thoại<span class="tx-danger ms-1">*</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="mb-2 fw-500">Xác nhận mật khẩu<span class="tx-danger ms-1">*</span></label>
                                                <div class="input-group">
                                                    <input class="form-control ms-0 border-end-0" type="password" placeholder="Create a Password" id="re-password">
                                                    <a href="javascript:void(0)" class="input-group-text bg-transparent tx-muted">
                                                        <i class="fe fe-eye tx-muted op-7" id="showPassword"></i>
                                                    </a>
                                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="d-grid mb-3">
                                        <button type="button" class="btn btn-white border">
                                            <img src="assets/images/png/45.png" class="me-2" alt="img" width="20">Đăng ký với Google
                                        </button>
                                    </div>
